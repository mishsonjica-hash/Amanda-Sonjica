...
3. Customer Loyalty Tiers contributed in the Revenue Decline (Hypothesis 3 – Correct): All three loyalty tiers (Bronze, Silver, Gold) experienced transaction and revenue declines in Western Cape, making it the epicenter of customer churn. The Silver tier was hit hardest, losing 145 transactions and suffering a 10.46% revenue drop in Western Cape alone. Total transaction losses across all tiers in Western Cape amounted to 241 customers (90 Bronze + 145 Silver + 6 Gold). While Western Cape generates higher revenue and transactions counts, in comparison to other provinces, it had the highest revenue drop between 2024 and 2025
